...
class ToyNet(nn.Module):
    def __init__(self, args):
        ...
        # decoder
        self.layer_rc1 = nn.Linear(args.K*2, 400)
        self.layer_rc2 = nn.Linear(400, 300)
        self.rc_cla = nn.Linear(300, len(constant.LABEL_TO_ID))
        self.layer_ner1 = nn.Linear(args.K, 200)
        self.layer_ner2 = nn.Linear(200, 100)
    ...
    def forward(self, inputs, num_sample=1):
        ...
        encoding_ner = F.relu(self.layer_ner2(encoding_ner))
        ...
        encoding_e = F.relu(self.layer_rc2(encoding_e))
