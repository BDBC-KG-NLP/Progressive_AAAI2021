...
class ToyNet(nn.Module):
    def __init__(self, args):
        ...
        self.layer1 = nn.Linear(self.rnn_hidden*2, 500)
        self.hidden2mean = nn.Linear(500, self.K)
        self.hidden2std = nn.Linear(500, self.K)

        # decoder
        self.rc_cla = nn.Linear(args.K*2, len(constant.LABEL_TO_ID))
